...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        System.out.println("whole date>>"+ remoteMessage);
    ...
    public void sendOreoNotification(RemoteMessage remoteMessage){
        ...
        Intent intent = new Intent(this, ChatMessageRequestActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, j, intent, PendingIntent.FLAG_ONE_SHOT);


        NotificationCompat.Builder builder = oreoNotification.getNotificationShit(title, body, pendingIntent,
                defaultSound, icon);
