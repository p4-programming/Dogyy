...
import com.aks.doggydoo.databinding.FragmentMyFriendsBinding
import com.aks.doggydoo.homemodule.adapter.MyFriendAdapter
...
@AndroidEntryPoint
class MyFriendsFrag : Fragment(R.layout.fragment_my_friends) {
